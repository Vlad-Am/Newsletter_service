...
class Newsletter(models.Model):
    ...
    frequency = models.CharField(
        max_length=10, choices=FREQUENCY_CHOICES, verbose_name="Частота рассылки"
    )
    ...
    datetime_end_send = models.DateTimeField(
...
class Logs(models.Model):
    time_last_send = models.DateTimeField(
    ...
    newsletter = models.ForeignKey(
        Newsletter, on_delete=models.CASCADE, verbose_name="Рассылка", null=True
    )
