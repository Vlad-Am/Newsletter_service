...
from mail.views import (ClientCreateView, ClientDeleteView, ClientDetailView,
                        ClientListView, ClientUpdateView, MessageCreateView,
...
urlpatterns = [
    ...
    path(
        ...
        name="newsletter_confirm_delete",
    ),
